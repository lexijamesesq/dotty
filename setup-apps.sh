...
git -C ~/bin/dotty remote set-url origin git@github.com:<user>/dotty.git 2>/dev/null
git -C ~/bin/dotty-private remote set-url origin git@github.com:<user>/dotty-private.git 2>/dev/null
