...
snippet: I'm a Director of Product Design at <employer> working on Assessments.
```
...
snippet: same shape as the <TEAM>-N example from the trial
```
...
snippet: Recommended by the team behind project/bramblesoft.
```
→ **Internal reference / Escalate.** "Bramblesoft" looks like a proper noun that could be a real company. Human judgment needed: is this a sanctioned public reference or a private one?
