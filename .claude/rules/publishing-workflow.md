...
GitHub push protection (server-side, 39 detectors) fires at step 3. The security-review GitHub Action fires on PR creation (advisory, requires `ANTHROPIC_API_KEY` repo secret).
