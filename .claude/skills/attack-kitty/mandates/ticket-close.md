...
Evidence vs. the ticket's own spec, refute posture. Gates `mark_done` (`/linear` `playbooks/closing.md` Step 1) — a ticket does not reach Done without a CONFIRMED (or gap-resolved) verdict from this mandate.
