<!-- Copied from Matt Pocock's prototype skill (MIT): https://github.com/mattpocock/skills. In map contexts the fold/lift steps are overridden by SKILL.md > Map contexts. -->
