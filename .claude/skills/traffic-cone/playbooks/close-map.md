...
- Does NOT re-validate individual slices — each child's own `mark_done` `[VALIDATION]` already verified it; `CM6` checks the map-conformance receipt, not per-child verdicts.
