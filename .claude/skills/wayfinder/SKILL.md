...
2. Choose the ticket. If the user named one, use it. Otherwise take the top frontier ticket (`/linear`'s frontier ordering). **Claim it** (spawn `` `@traffic-cone` `` `claim`) before any work.
