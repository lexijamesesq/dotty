...
- **Argument is anything else** — an issue identifier (`LEX-109`), a few words (`brainstorm voice notes`), a sentence describing what the user wants to do — → run the **Intent-Driven Sequence** below.
...
- `/session-start LEX-91` → Load project CLAUDE.md (derived from issue's project). Fetch LEX-91 + blockers. Skip Project Updates, queue, stale-debt, Knowledge scan.
